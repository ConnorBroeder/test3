...
class NetworksApp(App):
    def __init__(self, icon):
        super().__init__(icon)
        self.networks = ["Network 1", "Network 2", "Network 3"]
    ...
    def select_network(self, network_number):
        ...
        if network_number < 1 or network_number > len(self.networks):
            print("Invalid network number")
        else:
            self.selected_network = self.networks[network_number-1]
