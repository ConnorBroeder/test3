...
app_networks_icon = pygame.image.load("networks_icon.png").convert_alpha()  # New app icon
...
networks_icon = pygame.transform.scale(app_networks_icon, (icon_size, icon_size))  # New app icon
...
networks_icon_pos = (width // 2 + 10, height // 2 + 10)  # New app icon position
...
app_networks = App(networks_icon)  # New app without function
apps = [(app_settings, settings_icon_pos), (app_music, music_icon_pos), (app_timer, timer_icon_pos), (app_networks, networks_icon_pos)]  # Add new app to the list
